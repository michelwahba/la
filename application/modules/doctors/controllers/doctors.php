...
$data['doctor_clinics'] = $this->get_doctor_clinics($product_id);
...
function get_doctor_clinics($id){
$this->load->model('mdl_doctors');
$query = $this->mdl_doctors->get_doctor_clinics($id);
return $query;	
}
