...
<script  type="text/javascript">
    ...
    <div class="row well">
        ...
        <? if ( $rating > 0 ) {?> 
        <div><input type="text" value="<?php echo $rating;?>" class="rating rating5" /></div>    
        <? }?>         
    </div>
    
    <div class="row well" style="height:85px">    
        <div class="span4">
	...
	<div class="row well" style="margin-top:2%; height:100%">
    	<div class="col-md-6">  
        <h4><strong>Services</strong></h4>
        <?php foreach($categories->result() as $row1){
			echo '<a href="'.base_url().$this->uri->segment(1).'/'.$this->uri->segment(2).'/list_by_service/'.$row1->id.'/'.str_replace(' ', '_', preg_replace("/[^a-z0-9\\040\\.\\-\\_\\\]/i","_",$row1->name)).'">'.$row1->name.'</a><br />';
		}
		?>
         <address>
